...
public class ApplicationStateMachine {
    ...
    private static final Map<ApplicationState, Set<ApplicationState>> LEGAL_TRANSITIONS = Map.ofEntries(
        ...
        Map.entry(ApplicationState.APPROVED, EnumSet.of(ApplicationState.CONFIRMED_SUBMISSION, ApplicationState.APPLYING, ApplicationState.REJECTED, ApplicationState.CLOSED)),
        Map.entry(ApplicationState.CONFIRMED_SUBMISSION, EnumSet.of(ApplicationState.APPLYING, ApplicationState.SUBMISSION_REQUIRES_REVIEW, ApplicationState.FAILED, ApplicationState.ACTION_REQUIRED, ApplicationState.CLOSED, ApplicationState.REJECTED)),
